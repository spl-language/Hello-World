...
@MessageResolution(receiverType = HelloNull.class)
public class HelloNullMessageResolution {

    @Resolve(message = "IS_NULL")
    public abstract static class SLForeignIsNullNode extends Node {

        public Object access(Object receiver) {
            return HelloNull.SINGLETON == receiver;
        }
    }
    ...
    public abstract static class CheckNull extends Node {
        ...
        protected static boolean test(TruffleObject receiver) {
            return receiver instanceof HelloNull;
        }
    }
}
